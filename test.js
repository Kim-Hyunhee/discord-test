...
dotenv.config(); // Discord.js 모듈 불러오기
const client = new Discord.Client({ intents: [GatewayIntentBits.Guilds] }); // 이 Client는 Discord.js에서 핵심적으로 쓰이는 존재(?)라고 합니다.
...
client.on("message", (msg) => {
  // client에 message 이벤트가 발생할 경우의 동작 지정
